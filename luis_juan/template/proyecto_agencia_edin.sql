...
INSERT INTO `permiso` VALUES (123,'aldo',1),(3456,'terg',0),(9876,'jumm',0);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertar_permiso`(in idpermi int, in nom varchar(50))
BEGIN
insert into permiso (idpermiso,Nombre,Estado) values (idpermi,nom, '0');
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2024-07-05  9:09:22
