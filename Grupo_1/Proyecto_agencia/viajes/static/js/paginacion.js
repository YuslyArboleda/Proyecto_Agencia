  ...
  if (currentPage === 1) {
    ...
    <div class="container_paquetes1">
        ...
        <div class="container_informacion">
            <div class="informacion">
                <ul>
                    <h3>Producto RumboTravel - Choco - Cabaña piedra piedra</h3>
            ...
            <div class="boton">
               ...
               <button class="color_boton"><a href="detalles_nuqui.html">Ver mas</a></button>
            </div>
        </div>
    </div>
    ...
    <div class="container_paquetes2">
        ...
        <div class="container_informacion">
            <div class="informacion">
                <ul>
                    <h3>Producto RumboTravel - Choco - Cabaña Terco</h3>
                    <p>3 Días  2 Noche(s)</p>
                    <p>Acomodación: Cuadruple</p>
                    <p>Vigencia de viaje desde 2024-08-06 hasta 2024-12-20</p>         
                    <span>Ubicado en nuqui. A 50 minutos del aeropuerto de nuqui.</span><br>
            ...
            <div class="boton">
              ...
              <button class="color_boton"><a href="detalle_nuqui_terco.html">Ver mas</a></button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container_paquetes1">
        ...
        <div class="container_informacion">
            <div class="informacion">
                <ul>
                    <h3>Producto RumboTravel - Choco- cabañas-Guachalito</h3>
                    <p>3 Días  2 Noche(s)</p>
                    <p>Acomodación: Cuadruple</p>
                    <p>Vigencia de viaje desde 2024-08-06 hasta 2024-12-20</p>         
                    <span>Ubicado en nuqui. A 50 minutos del aeropuerto de nuqui.</span><br>
            ...
            <div class="boton">
              ...
              <button class="color_boton"><a href="detalle_nuqui_guachalito.html">Ver mas</a></button>
            </div>
        </div>
    </div>
    ...
    <div class="container_paquetes2">
        ...
        <div class="container_informacion">
            <div class="informacion">
                <ul>
                    <h3>Producto RumboTravel - Choco - Cabaña Morromico</h3>
                    <p>3 Días  2 Noche(s)</p>
                    <p>Acomodación: Cuadruple</p>
                    <p>Vigencia de viaje desde 2024-08-06 hasta 2024-12-20</p>         
                    <span>Ubicado en nuqui. A 50 minutos del aeropuerto de nuqui.</span><br>
            ...
            <div class="boton">
             ...
             <button class="color_boton"><a href="detalle_nuqui_morromico.html">Ver mas</a></button>
            </div>
        </div>
    </div>
  </div>
    ...
    const contentHtml = `      
        ...
        <div class="container_paquetes1">
            ...
            <div class="container_informacion">
                <div class="informacion">
                    <ul>
                        <h3>Producto RumboTravel - Choco- cabañas-Utria</h3>
                        <p>3 Días  2 Noche(s)</p>
                        <p>Acomodación: Cuadruple</p>
                        <p>Vigencia de viaje desde 2024-08-06 hasta 2024-12-20</p>         
                        <span>Ubicado en nuqui. A 50 minutos del aeropuerto de nuqui.</span><br>
                ...
                <div class="boton">
                  ...
                  <button class="color_boton"><a href=" detalle_nuqui_utria.html">Ver mas</a></button>
                </div>
            </div>
        </div>
    `;
